      ...
      <Section labelledBy="para-quem">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <SectionHeading
            id="para-quem"
            eyebrow="Para quem é"
            title="Sinais de que você precisa disso."
            text="Se você se reconhece em pelo menos um destes pontos, há retorno para buscar."
          />
          <Checklist items={service.forWho} className="text-lg" />
        </div>
      </Section>

      {/* 4–5: Como funciona + O que está incluso */}
      <Section tone="mist" labelledBy="como-funciona">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div>
            <SectionHeading id="como-funciona" eyebrow="Como funciona" title={`${service.steps.length} passos, do conhecimento ao resultado.`} />
            <div className="mt-10">
              <StepsList steps={service.steps} />
            </div>
          </div>
