        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          {complementaryServices.map((s) => (
            <Link
              key={s.href}
              href={s.href}
              className="group flex h-full flex-col rounded-[var(--radius-card)] border border-line bg-white p-8 shadow-[var(--shadow-card)] transition-all hover:-translate-y-0.5 hover:border-signal/40 hover:shadow-[var(--shadow-lift)] md:p-10"
            >
