          ...
          {glossary.map((t) => (
            <li key={t.slug}>
              <Link
                ...
                className="inline-block rounded-full border border-line bg-white px-4 py-2 font-medium shadow-[var(--shadow-card)] transition-colors hover:border-signal hover:text-signal"
              >
                {t.term}
              </Link>
            </li>
